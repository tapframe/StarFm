    ...
    <section className="relative h-[calc(100vh-5rem)] sm:h-[calc(100vh-6rem)] min-h-[600px] w-full overflow-hidden">
      ...
      <div className="container relative z-20 h-full flex flex-col justify-center px-4 sm:px-6 lg:px-8 pb-16 sm:pb-0">
        <div className="max-w-4xl">
          ...
          {/* Subtitle */}
          <p className="mb-2 text-white/80 dark:text-white/90 font-semibold text-sm sm:text-base uppercase tracking-[0.2em] hero-text-shadow">
            {currentData.subtitle}
          </p>

          {/* Title */}
          <h1 className="mb-4 font-sans text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold text-white leading-tight tracking-normal hero-text-shadow">
            {currentData.title}
          </h1>

          {/* Description */}
          <p className="mb-6 text-base sm:text-base lg:text-lg text-white/80 dark:text-white/90 font-normal leading-relaxed max-w-2xl hero-text-shadow">
          ...
          {/* Stat Badge */}
          <div className="inline-flex items-baseline gap-4 px-8 py-4 rounded-2xl bg-white/10 dark:bg-slate-900/50 backdrop-blur-md border border-white/20">
